                ...
                >
                  <section className="relative flex h-full flex-col">
                    <header className="fixed top-0 z-10 flex w-full max-w-md items-center justify-between border-b border-border-200 border-opacity-75 bg-light px-6 py-4">
                      ...
                      <button className="flex h-7 w-7 items-center justify-center rounded-full bg-green-500 text-muted transition-all duration-200 hover:bg-green-600 hover:text-light focus:bg-green-600 focus:text-white focus:outline-0 ltr:ml-3 ltr:-mr-2 rtl:mr-3 rtl:-ml-2">
